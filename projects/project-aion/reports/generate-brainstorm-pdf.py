#!/usr/bin/env python3
"""
Project Aion Integration Brainstorm — PDF Generator
...
# --- Configuration ---
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "project-aion-integration-brainstorm.pdf")
CONTENT_PATH = os.path.join(os.path.dirname(__file__), "multi-archon-integration-brainstorm-2026-03-29.md")
...
def add_page_number(canvas, doc):
    ...
    canvas.drawCentredString(
        letter[0] / 2, 0.5 * inch,
        f"Project Aion Integration Brainstorm — Page {doc.page}"
    )
    canvas.restoreState()
...
def build_cover(styles):
    ...
    elements.append(Spacer(1, 12))
    elements.append(Paragraph("Integration Brainstorm", ParagraphStyle(
...
def main():
    ...
    doc = SimpleDocTemplate(
        ...
        title="Project Aion Integration Brainstorm",
        author="Jarvis (Master Archon)",
        subject="Future Integration Strategy",
    )
