...
│ 2. Create project at /Users/nathanielcannon/Claude/<name>/           │
...
```bash
# NOT in Jarvis!
mkdir -p /Users/nathanielcannon/Claude/my-new-project
cd /Users/nathanielcannon/Claude/my-new-project
```
...
development:
  projects:
    my-new-project:
      path: "/Users/nathanielcannon/Claude/my-new-project"
      type: "api"
      language: "typescript"
      status: "active"
      created: "2026-01-05"
...
1. Project directory exists at `/Users/nathanielcannon/Claude/<name>/`
...
```bash
# Quick validation
ls -la /Users/nathanielcannon/Claude/my-new-project/
cat /Users/nathanielcannon/Claude/my-new-project/CLAUDE.md
