...
TELEMETRY_DIR="$HOME/Claude/Jarvis/.claude/logs/telemetry"
METRICS_DIR="$HOME/Claude/Jarvis/.claude/metrics"
...
generate_dashboard() {
    ...
    local state_dir="$HOME/Claude/Jarvis/.claude/state/components"
