...
TELEMETRY_DIR="$HOME/Claude/Project_Aion/.claude/logs/telemetry"
METRICS_DIR="$HOME/Claude/Project_Aion/.claude/metrics"
...
generate_dashboard() {
    ...
    local state_dir="$HOME/Claude/Project_Aion/.claude/state/components"
