# Getting Started with AIfred Pro Dev

Configured: 2026-04-23 | Profile: general+homelab+development+production | Automation: Full

**This is the dev workspace** for contributing to `CannonCoPilot/Project_Aion` on branch `main`.
Dev stack runs on ports 8701 (dashboard) and 8800 (pulse), separate from any prod instance.
