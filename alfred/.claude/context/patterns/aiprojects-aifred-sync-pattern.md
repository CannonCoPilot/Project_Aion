...
sed -i 's|/home/<original_user>/AIProjects|${AIFRED_ROOT:-$HOME/AIfred}|g' file
sed -i 's|/home/<original_user>/Code|${PROJECTS_ROOT:-$HOME/Code}|g' file
...
- [ ] Replace `/home/<original_user>/AIProjects` → `<project_root>` or `${AIFRED_ROOT}`
- [ ] Replace `/home/<original_user>/Code` → `<projects_root>` or `${PROJECTS_ROOT}`
