...
**Primary Workspace**: `${OBSIDIAN_VAULT_PATH}/AI-Sessions/` (configure in paths-registry.yaml)
...
Standard check:
```
Read: ${OBSIDIAN_VAULT_PATH}/AI-Sessions/_inbox.md
```

### Creating Session Folders

Path pattern: `${OBSIDIAN_VAULT_PATH}/AI-Sessions/YYYY/MM/DD-topic-name/`

Example: `${OBSIDIAN_VAULT_PATH}/AI-Sessions/2026/01/02-obsidian-integration/`
